 ...
 *
 * @class Node
 * @classDescription node used in AvlTree
 * @property {Node} left       left child node
 * @property {Node} right      right child node
 * @property {null|number} height   local height of the tree from this node
 * @property {object} key      key used in comparisons with other nodes
 * @property {object} value    pay-lode data attached to this Node
 *
 * @private
